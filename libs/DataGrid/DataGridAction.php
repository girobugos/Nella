 ...
 * @version    $Id$
 */
class DataGridAction extends Nette\Component implements IDataGridAction
{
	/** @var Closure|array|string */
	public $ifCallback = NULL;
	 ...
	 * @return void
	 */
	public function __construct($title, $destination, Html $icon = NULL, $ajaxClass = NULL, $key = self::WITH_KEY)
	{
		parent::__construct();
		...
		if ($ajaxClass) $a->addClass($ajaxClass);
